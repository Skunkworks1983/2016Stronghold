...
#define COLLECTOR_ROTATION_ENCODER_FLOOR_TICKS -1537
#define COLLECTOR_ROTATION_ENCODER_TOP_TICKS 15

#define CLIMBER_WINCH_DOWN_POSITION 0
#define CLIMBER_WINCH_UP_POSITION 50
...
#define COLLECTOR_ROTATION_P .00045
