...
#define COLLECTOR_ROTATION_ENCODER_TOP_TICKS -1 * COLLECTOR_ROTATION_TICKS_PER_DEGREE
#define COLLECTOR_ROTATION_ENCODER_45_TICKS 70 * COLLECTOR_ROTATION_TICKS_PER_DEGREE
#define COLLECTOR_ROTATION_ENCODER_60_TICKS 45 * COLLECTOR_ROTATION_TICKS_PER_DEGREE
#define COLLECTOR_ROTATION_ENCODER_LOWB_TICKS 120 * COLLECTOR_ROTATION_TICKS_PER_DEGREE
#define COLLECTOR_ROTATION_ENCODER_COLLECT_TICKS 130 * COLLECTOR_ROTATION_TICKS_PER_DEGREE
